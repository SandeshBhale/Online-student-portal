                  ...
                  <div class="card">
                    <div class="card-body ">
                        ...
                        <table class="table table-hover table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm ">
                            ...
                            <?php
                                include "dbcon.php"; 
                                $records = mysqli_query($con,"SELECT * FROM assignment WHERE branch='CIVIL' "); 
                ...
                <div class="col-lg-4 grid-margin stretch-card mx-auto">
                  <div class="card">
                    <div class="card-body table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                      ...
                      <?php 
                          $sql ="SELECT * FROM submission_log WHERE semester IN ('First','Second') and branch='CIVIL' ORDER BY id DESC ;";
                ...
                <div class="col-lg-4 grid-margin stretch-card mx-auto">
                  <div class="card">
                    <div class="card-body table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                      ...
                      <?php 
                          $sql ="SELECT * FROM submission_log WHERE semester IN ('Third','Fourth') and branch='CIVIL' ORDER BY id DESC;";
                          $execute = mysqli_query($con,$sql);
                          while($data = mysqli_fetch_array($execute)){
                      ?>
                        <span> <?php echo $data['log'];?></span><br><br>
                ...
                <div class="col-lg-4 grid-margin stretch-card mx-auto">
                  <div class="card">
                    <div class="card-body table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                      ...
                      <?php 
                          $sql ="SELECT * FROM submission_log WHERE semester IN ('Fifth','Sixth') and branch='CIVIL' ORDER BY id DESC;";
                          $execute = mysqli_query($con,$sql);
                          while($data = mysqli_fetch_array($execute)){
                      ?>
                        <span> <?php echo $data['log'];?></span><br><br>
                  ...
                  <div class="card">
                    ...
                    <?php
                        if(isset($_POST['clear'])){
                          $del = "DELETE FROM submission_log WHERE branch='CIVIL'";
