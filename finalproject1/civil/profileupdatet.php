...
if(!isset($_SESSION['username'])){
  header('location: singinasteacher.php');  
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <body>
    <?php
            include 'dbcon.php';
            $id=$_SESSION['id'];
            $emailsearch= " SELECT * FROM teacher WHERE id='$id' ";
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <input name="name"class="profileinput"type="text"value="<?php echo $row['name'];  ?>">
                        </div>
                      </div>
                      <hr>
                      <div class="row">
              ...
              <?php
                if(isset($_POST['submit'])){
                  ...
                  if(in_array($filecheck,$fileextstored)){
                      ...
                      $query = " UPDATE teacher SET image='$destinationfile' WHERE id='$id' ";
                      $result = mysqli_query($con, $query) or die(mysqli_error($con));
                  }
                  $query = " UPDATE teacher SET name='$name',phone='$phone',address='$address',city='$city',gender='$gender'WHERE id='$id' ";
                              $result = mysqli_query($con, $query) or die(mysqli_error($con));
                              ?>
