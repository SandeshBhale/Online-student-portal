                ...
                <div required class="input-row" style="margin-top: -15px;">
                  ...
                  <select name="subject" class="form-control"style="width: 100%; padding: 12px 8px; display: inline-block; border: 1px solid #ccc; box-sizing: border-box;font-size:0.8rem;"required>                                          
                      <optgroup label="First Semester">
                        ...
                        <option value="BSC">Basic Science (Physics & Chemistry)</option>
                        <option value="BMS">Basic Mathematics</option>
                      </optgroup>

                      <optgroup label="Second Semester">
                        <option value="AME">Applied Mechanics</option>
                        <option value="AMS">Applied Mathematics</option>
                        <option value="ASM">Applied Science (Physics & Chemistry)</option>
                        <option value="BSU">Basic Surveying</option>
                        <option value="CEW">Civil Engineering Workshop and Practice</option>
                        <option value="BCC">Business Communication Using Computers</option>
                      </optgroup>

                      <optgroup label="Third Semester">
                        <option value="ASU">Advanced Surveying</option>
                        <option value="HEN">Highway Engineering</option>
                        <option value="MOS">Mechnacis of Structures</option>
                        <option value="BCO">Building Construction</option>
                        <option value="CTE">Concrete Technology</option>
                        <option value="CAD">Computer Aided Drawing</option>
                      </optgroup>

                      <optgroup label="Fourth Semester">
                        <option value="HRY">Hydraulics</option>
                        <option value="TOS">Theory of Stuructures</option>
                        <option value="RBE">Railway and Bridge Engineering</option>
                        <option value="GTE">Geo-Technical Engineering</option>
                        <option value="BPD">Building Planning and Drawing</option>
                        <option value="EST">Environmental Studies</option>
                      </optgroup>

                      <optgroup label="Fifth Semester">
                        <option value="WRE">Water Resorce Engineering</option>
                        <option value="DSR">Design of Steel and RCC Structures</option>
                        <option value="EAC">Estimating and Costing</option>
                        <option value="PHE">Public Health Engineering</option>
                        <option value="ITR">Industrial Training</option>
                        <option value="CPP">Capstone Project Planning</option>
                        <option value="TEN">Traffic Engineering</option>
                      </optgroup>
                      <optgroup label="Sixth Semester">
                        <option value="MAN">Management</option>
                        <option value="CAA">Contracts and Accounts</option>
                        <option value="MRS">Maintenance and Repairs of Structures</option>
                        <option value="ETC">Emerging Trends in Civil Engineering</option>
                        <option value="SWM">Solid Waste Management</option>
                        <option value="CPE">Capstone Project- Execution and Report Writing</option>
                        <option value="CMA">Construction Management</option>
                        <option value="EDP">Entreprenuership Development</option>
                      </optgroup>
                  </select>
                </div>
                <div class="input-row"style="font-size:0.8rem;">
