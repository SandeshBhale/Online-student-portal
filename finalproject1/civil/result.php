              ...
              <div class="row">
                <div class="card mx-auto" style="height:100%;width:80%;margin-top:10px;">
                  <?php
                    ...
                    $rs=mysqli_query($con,"SELECT t.test_name,t.total_que,r.test_date,r.score FROM mst_test t, mst_result r WHERE t.test_id=r.test_id AND t.branch='CIVIL' AND r.login='$login'",$cn) or die(mysqli_error());
