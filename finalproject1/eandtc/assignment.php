                  ...
                  <div class="card-body table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                    <!-- <div class="card"> -->
                      <!-- <div class="container"> -->
                        ...
                        <?php 
                          $sql="SELECT * FROM assignment WHERE semester IN ('First','Second') and branch='E&TC';";
              ...
              <div class="col-xl-4 col-lg-6 col-md-4 grid-margin stretch-card mx-auto">
                <div class="card">
                  <div class="card-body table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                        ...
                        <?php 
                          $sql="SELECT * FROM assignment WHERE semester IN ('Third','Fourth') and branch='E&TC';";
                          $execute = mysqli_query($con,$sql);
                          while($data  = mysqli_fetch_array($execute)){     
                          $no = $data['id']                       ;
                        ?>
              ...
              <div class="col-xl-4 col-lg-6 col-md-4 grid-margin stretch-card mx-auto">
                <div class="card">
                  <div class="card-body table-responsive-xl table-responsive-lg table-responsive-md table-responsive-sm">
                        ...
                        <?php 
                          $sql="SELECT * FROM assignment WHERE semester IN ('Fifth','Sixth')and branch='E&TC';";
                          $execute = mysqli_query($con,$sql);
                          while($data  = mysqli_fetch_array($execute)){     
                          $no = $data['id']                       ;
                        ?>
