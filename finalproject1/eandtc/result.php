              ...
              <div class="row">
                <div class="card mx-auto" style="height:100%;width:80%;margin-top:10px;">
                  <?php
                    ...
                    $rs=mysqli_query($con,"SELECT t.test_name,t.total_que,r.test_date,r.score FROM mst_test t, mst_result r WHERE t.test_id=r.test_id AND t.branch='E&TC' AND r.login='$login'",$cn) or die(mysqli_error());
                    ...
                    echo "<table class='table table-striped table-dark w-75 text-center mx-auto table-responsive-md table-responsive-sm'><tr><td width=200>Test Name <td> Total<br> Question <td> Score";
                    ...
                    echo "<h1 align=center style='font-size:1.5rem;margin-top:15px;'><a href=showtest.php class='text-decoration-none'>Start New test</a> </h1>"; 
