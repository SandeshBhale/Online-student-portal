            ...
            <div class="comment-form-container bg-white">
              <form id="frm-comment">
                <div class="input-row"style="font-size:0.8rem;">
                    <input type="hidden" name="comment_id" id="commentId"placeholder="Name" /> <input class="input-field form-control"type="text" id="name" placeholder="Full Name"/>
                </div>
                  ...
                  <label for="subject"></label>
                    <select name="subject" class="form-control"style="width: 100%; padding: 12px 8px; display: inline-block; border: 1px solid #ccc; box-sizing: border-box;font-size:0.8rem;">
                      ...
                      <optgroup label="Second Semester">
                        ...
                        <option value="AMI">Applied Mathematics</option>
                        <option value="PCI">Programming in C</option>
                        <option value="BEC">Basic Electronics</option>
                      </optgroup>

                      <optgroup label="Third Semester">
                        <option value="DTE">Digital Techniques</option>
                        <option value="OOP">Object Oriented Programming Using C++</option>
                        <option value="CGR">Computer Graphics</option>
                        <option value="DMS">Database Management System</option>
                        <option value="DSU">Data Structure Using C</option>
                      </optgroup>

                      <optgroup label="Fourth Semester">
                        <option value="JPR">Java Progrmming</option>
                        <option value="SEN">Software Engineering</option>
                        <option value="DCC">Data Communication and Computer Network</option>
                        <option value="MIC">Microprocessors</option>
                      </optgroup>

                      <optgroup label="Fifth Semester">
                        <option value="OSY">Operating Systems</option>
                        <option value="AJP">Advance Java Programming</option>
                        <option value="STE">Software Testing</option>
                        <option value="CSS">Client Side Scripting Language</option>
                        <option value="EST">Environmental Studies</option>
                      </optgroup>
                      <optgroup label="Sixth Semester">
                        <option value="MGT">Management</option>
                        <option value="PWP">Programming With Python</option>
                        <option value="MAD">Mobile Application Development</option>
                        <option value="WBP">Web Based Application Development Using PHP</option>
