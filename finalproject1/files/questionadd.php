...
{
extract($_POST);
mysqli_query($con,"insert into mst_question(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans,branch) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue','COMP')",$cn) or die(mysqli_error());
      ...
      <form name="form1" method="post" onSubmit="return check();">
        <div class="form-group col-md-10 mx-auto">
          ...
          <select requried name="testid"class="form-control" id="testid">
            <?php
              $rs=mysqli_query($con,"Select * from mst_test where branch='COMP'",$cn);
