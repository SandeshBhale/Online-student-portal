            ...
            <div class="content-wrapper">  
              <div class="row">
                ...
                <?php
                    ...
                    $rs=mysqli_query($con,"SELECT t.test_name,t.total_que,r.test_date,r.score FROM mst_test t, mst_result r WHERE t.test_id=r.test_id AND t.branch='COMP' AND r.login='$login'",$cn) or die(mysqli_error());
