  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <a class="navbar-brand" href="index.html"><span class="text-osp display-4 font-weight-bold text-primary">OSP</span></a>
        </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link " href="files/profileupdate.php">
            ...
            <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white my-cards">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-4 mt-4">Total Students<i class="mdi mdi-account mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white my-cards">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-4 mt-4">Total Teachers<i class="mdi mdi-account-star mdi-24px float-right"></i>
                    </h4>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white my-cards">
                  <div class="card-body">
                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-4 mt-4">Visitors Online <i class="mdi mdi-counter mdi-24px float-right"></i>
                    </h4>
                      ...
                      <div id="carouselExampleControls" class="carousel slide " data-ride="carousel">
                        <div class="carousel-inner ">
                          <div class="carousel-item active text-center my-captions1"style="height:270px;">
                              <h2 class="text-success">WHO ARE WE</h2>
                              <h4 class="text-dark">We are a group of highly motivated students and we are trying to solve the daily life problems of students which hinder them to be successful in their lives.</h4>
                          </div>
                          <div class="carousel-item text-center my-captions2">
                              <h2 class="text-success">WHAT WE PROVIDE</h2>
                              <h4 class="text-dark">Online student portal is a web application which is useful for learners to choose right information. OSP provides services like, E-Resources, online Test, Query Board, news and events.</h4>
                          </div>
                          <div class="carousel-item text-center my-captions3">
                              <h2 class="text-success">OUR MISSION</h2>
                              <h4 class="text-dark">We Aims to provide the student portal to college for maintain and keep track on students progress. The main purpose behind developing student portal is to make the process of learning online more simpler. Student become up-to-date by accessing student portal.</h4>
                          </div>
                        </div>
