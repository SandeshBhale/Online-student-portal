                        ...
                        <div class="card p-5"style="border-radius:0;">
                            <table class="table table-bordered table-hover table-responsive-md table-responsive-lg table-responsive-xl">
                                ...
                                <tr>
                                    <td><b>MON</b></td>
                                    <td>EDE</td>
                                    <td colspan="2">IHP B1 & AEN B2</td>                    
                                    <td>R</td>                     
                                    <td colspan="2">CPP B1 & B2</td>                     
                                    <td>IEQ</td>                     
                                    <td colspan="2">NET SURRIFING</td>                     
                                                        
                                </tr>
                                <tr>
                                    <td><b>TUE</b></td>
                                    <td colspan="2">RET  BT & IEQ B1</td>
                                    <td>ETM</td>                  
                                    <td>E</td>                     
                                    <td>EDE</td>                     
                                    <td>IHP</td>                     
